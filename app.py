...
st.plotly_chart(build_cost_by_level_chart(cost_by_level_df), use_container_width=True)
st.dataframe(cost_by_level_df, use_container_width=True)

st.subheader("Event Mix")
st.plotly_chart(build_event_mix_chart(event_mix_df), use_container_width=True)
st.dataframe(event_mix_df.head(20), use_container_width=True)

st.subheader("Peak Usage by Hour")
st.plotly_chart(build_hourly_usage_chart(hourly_df), use_container_width=True)
